...
const patchNotes = [
  'v0.5.3  Peaceful mode now has its own cleaner lane: relic quest flow, temple-head completion reward, hidden combat-only HUD/upgrades, removed sprint/eating pressure, stronger relic glow, safer relic spawn spacing, and fork debug polish.',
  ...
  <div id="creditsMenu" class="overlay hidden">
    <div class="panel">
      ...
      <div id="creditsList" class="stack credits-list">
        ...
        <div class="patch-note">Music by <a href="https://pixabay.com/users/unrealmicikcz12-45643619/?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=235545" target="_blank" rel="noopener noreferrer">Unrealmicikcz12</a> from <a href="https://pixabay.com/music//?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=235545" target="_blank" rel="noopener noreferrer">Pixabay</a></div>
        <div class="patch-note">Music by <a href="https://pixabay.com/users/juraganvisi-52255643/?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=408697" target="_blank" rel="noopener noreferrer">Juragan Visi</a> from <a href="https://pixabay.com//?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=408697" target="_blank" rel="noopener noreferrer">Pixabay</a></div>
        <div class="patch-note">Music by <a href="https://pixabay.com/users/arizonaguide-20571657/?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=404605" target="_blank" rel="noopener noreferrer">Arizona Guide</a> from <a href="https://pixabay.com//?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=404605" target="_blank" rel="noopener noreferrer">Pixabay</a></div>
        <div class="patch-note">Music by <a href="https://pixabay.com/users/sonic289-51200122/?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=372754" target="_blank" rel="noopener noreferrer">Noppadol Butdeangnoi</a> from <a href="https://pixabay.com//?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=372754" target="_blank" rel="noopener noreferrer">Pixabay</a></div>
        <div class="patch-note">Music by <a href="https://pixabay.com/users/kontraa-24653570/?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=483028" target="_blank" rel="noopener noreferrer">Kontraa Music</a> from <a href="https://pixabay.com/music//?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=483028" target="_blank" rel="noopener noreferrer">Pixabay</a></div>
        <div class="patch-note">Music by <a href="https://pixabay.com/users/delosound-46524562/?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=321106" target="_blank" rel="noopener noreferrer">DELOSound</a> from <a href="https://pixabay.com/music//?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=321106" target="_blank" rel="noopener noreferrer">Pixabay</a></div>
        <div class="patch-note">Music by <a href="https://pixabay.com/users/nickpanekaiassets-38266323/?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=378774" target="_blank" rel="noopener noreferrer">Nicholas Panek</a> from <a href="https://pixabay.com//?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=378774" target="_blank" rel="noopener noreferrer">Pixabay</a></div>
        <div class="patch-note">Music by <a href="https://pixabay.com/users/leberch-42823964/?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=375269" target="_blank" rel="noopener noreferrer">Nikita Kondrashev</a> from <a href="https://pixabay.com//?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=375269" target="_blank" rel="noopener noreferrer">Pixabay</a></div>
        <div class="patch-note">Music by <a href="https://pixabay.com/users/leberch-42823964/?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=517463" target="_blank" rel="noopener noreferrer">Nikita Kondrashev</a> from <a href="https://pixabay.com//?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=517463" target="_blank" rel="noopener noreferrer">Pixabay</a></div>
        <div class="patch-note">Sound Effect by <a href="https://pixabay.com/users/r0t0r-34451638/?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=151673" target="_blank" rel="noopener noreferrer">R0T0R</a> from <a href="https://pixabay.com//?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=151673" target="_blank" rel="noopener noreferrer">Pixabay</a></div>
      </div>
      <div class="stack" style="margin-top:16px">
...
function clampSpawnY(y) {
  return Math.min(y, maxSwimY);
}

function randomSpawnY(minY, maxY) {
  const cappedMaxY = Math.min(maxY, maxSwimY);
  return minY + Math.random() * Math.max(0, cappedMaxY - minY);
}

for (let i = 0; i < 120; i++) {
  const p = new THREE.Mesh(new THREE.BoxGeometry(0.08, 0.08, 0.08), new THREE.MeshBasicMaterial({ color: 0xb8ffb0 }));
  p.position.set((Math.random() - 0.5) * 140, randomSpawnY(-20, 20), (Math.random() - 0.5) * 140);
  stars.add(p);
}
scene.add(stars);
...
for (let i = 0; i < 18; i++) {
  ...
  ray.position.set(Math.cos(angle) * (8 + Math.random() * 28), randomSpawnY(-6, 0), Math.sin(angle) * (8 + Math.random() * 28));
...
function makeAlien(overridePos = null) {
  ...
  const a = Math.random() * Math.PI * 2;
  group.position.set(overridePos ? overridePos.x : Math.cos(a) * r, overridePos ? clampSpawnY(overridePos.y) : randomSpawnY(-72, -10), overridePos ? overridePos.z : Math.sin(a) * r);
  scene.add(group);
...
function makePickup(kind = Math.random() < 0.12 ? 'steak' : Math.random() < 0.45 ? 'fish' : 'worm') {
  ...
  const a = Math.random() * Math.PI * 2;
  group.position.set(Math.cos(a) * r, kind === 'worm' ? randomSpawnY(-87, -35) : randomSpawnY(-76, -8), Math.sin(a) * r);
...
function makeNarwhal(index = narwhals.length, overridePos = null) {
  const group = new THREE.Group();
  ...
  group.position.set(Math.cos(angle) * 28, overridePos ? clampSpawnY(overridePos.y) : randomSpawnY(-46, -38), Math.sin(angle) * 28);
  scene.add(group);
...
function makeLeviathan(overridePos) {
  ...
  const a = Math.random() * Math.PI * 2;
  group.position.set(overridePos ? overridePos.x : Math.cos(a) * r, overridePos ? clampSpawnY(overridePos.y) : randomSpawnY(-45, -27), overridePos ? overridePos.z : Math.sin(a) * r);
  scene.add(group);
...
function makeShark(overridePos) {
  ...
  const a = Math.random() * Math.PI * 2;
  group.position.set(overridePos ? overridePos.x : Math.cos(a) * r, overridePos ? clampSpawnY(overridePos.y) : randomSpawnY(-60, -20), overridePos ? overridePos.z : Math.sin(a) * r);
  scene.add(group);
...
function makeTuna(overridePos) {
  ...
  group.position.set(overridePos ? overridePos.x : Math.cos(a) * r, overridePos ? clampSpawnY(overridePos.y) : randomSpawnY(-50, -10), overridePos ? overridePos.z : Math.sin(a) * r);
  scene.add(group);
...
function makeOctopus(overridePos) {
  ...
  const a = Math.random() * Math.PI * 2;
  group.position.set(overridePos ? overridePos.x : Math.cos(a) * r, overridePos ? clampSpawnY(overridePos.y) : randomSpawnY(-45, -15), overridePos ? overridePos.z : Math.sin(a) * r);
  scene.add(group);
...
function makeJellyfish(overridePos) {
  ...
  const a = Math.random() * Math.PI * 2;
  group.position.set(overridePos ? overridePos.x : Math.cos(a) * r, overridePos ? clampSpawnY(overridePos.y) : randomSpawnY(-38, -6), overridePos ? overridePos.z : Math.sin(a) * r);
  scene.add(group);
...
function makeSeahorse() {
  ...
  const a = Math.random() * Math.PI * 2;
  group.position.set(Math.cos(a) * r, randomSpawnY(-60, -5), Math.sin(a) * r);
  scene.add(group);
...
function makeGlowOrb() {
  ...
  const a = Math.random() * Math.PI * 2;
  group.position.set(Math.cos(a) * r, randomSpawnY(-72, -14), Math.sin(a) * r);
  scene.add(group);
...
function makeAnemone() {
  ...
  const a = Math.random() * Math.PI * 2;
  group.position.set(Math.cos(a) * r, -82.0, Math.sin(a) * r);
  scene.add(group);
...
function makeUrchin(overridePos) {
  ...
  group.position.set(overridePos ? overridePos.x : Math.cos(a) * r, overridePos ? clampSpawnY(overridePos.y) : -83.5, overridePos ? overridePos.z : Math.sin(a) * r);
...
function makeCrab(overridePos) {
  ...
  group.position.set(overridePos ? overridePos.x : Math.cos(a2) * r, overridePos ? clampSpawnY(overridePos.y) : -82.5, overridePos ? overridePos.z : Math.sin(a2) * r);
...
function makeCrystal() {
  ...
  group.position.set(Math.cos(a) * r, randomSpawnY(-55, 5), Math.sin(a) * r);
  scene.add(group);
...
function makeAnglerfish(overridePos) {
  ...
  const a = Math.random() * Math.PI * 2;
  group.position.set(overridePos ? overridePos.x : Math.cos(a) * r, overridePos ? clampSpawnY(overridePos.y) : randomSpawnY(-68, -38), overridePos ? overridePos.z : Math.sin(a) * r);
  group.rotation.y = Math.random() * Math.PI * 2;
  scene.add(group);
...
function updateAnglerfish(dt, now) {
  ...
  for (let i = anglerfish.length - 1; i >= 0; i--) {
    ...
    if (Math.abs(dx) > worldRadius || Math.abs(dz) > worldRadius) {
      ...
      af.mesh.position.y = randomSpawnY(-68, -38);
    }

    af.bob += dt * 2.2;
    af.lurePhase += dt * 1.4;
    af.mesh.position.y += Math.sin(af.bob) * 0.015;
    af.mesh.position.y = clampSpawnY(af.mesh.position.y);
...
function makePearl(overridePos) {
  ...
  orb.position.set(overridePos ? overridePos.x : Math.cos(a) * r, overridePos ? clampSpawnY(overridePos.y) : -83.2, overridePos ? overridePos.z : Math.sin(a) * r);
  scene.add(orb);
...
function makePlanktonPatch() {
  ...
  group.position.set(Math.cos(a) * r, randomSpawnY(-52, -14), Math.sin(a) * r);
  scene.add(group);
...
function makeMotes() {
  ...
  for (let i = 0; i < 80; i++) {
    ...
    mote.position.set((Math.random() - 0.5) * worldRadius, randomSpawnY(-20, 60), (Math.random() - 0.5) * worldRadius);
...
function openOverlay(id) {
  ...
  if (renderer?.domElement) renderer.domElement.style.opacity = (id === 'mainMenu' || id === 'gameModeMenu' || id === 'storyMenu' || id === 'tutorialMenu') ? '0' : '1';
...
function updatePlayer(dt) {
  ...
  if (player.pos.y < minSwimY) {
    player.pos.y = minSwimY;
    player.verticalVelocity = Math.max(0, player.verticalVelocity);
  }
  if (player.pos.y > maxSwimY) {
    player.pos.y = maxSwimY;
...
function updateAliens(dt, now) {
  ...
  for (const alien of aliens) {
    ...
    if (alien.mesh.position.y - player.pos.y < -45) alien.mesh.position.y = clampSpawnY(alien.mesh.position.y + 90);
  }
  for (let i = aliens.length - 1; i >= 0; i--) {
    ...
    alien.mesh.position.y = clampSpawnY(alien.mesh.position.y);
...
function updatePickups(dt) {
  ...
  for (let i = pickups.length - 1; i >= 0; i--) {
    ...
    if (p.mesh.position.y - player.pos.y < -45) p.mesh.position.y = clampSpawnY(p.mesh.position.y + 90);
    p.mesh.rotation.y += dt * p.spin;
    p.mesh.position.y += Math.sin(performance.now() * 0.002 + i) * 0.01;
    p.mesh.position.y = clampSpawnY(p.mesh.position.y);
...
function updateSharks(dt, now) {
  ...
  for (let i = sharks.length - 1; i >= 0; i--) {
    ...
    if (shark.mesh.position.y - player.pos.y < -45) shark.mesh.position.y = clampSpawnY(shark.mesh.position.y + 90);
    ...
    shark.mesh.position.y = clampSpawnY(shark.mesh.position.y);
...
function updateTunas(dt, now) {
  for (let i = tunas.length - 1; i >= 0; i--) {
    ...
    tuna.mesh.position.y = clampSpawnY(tuna.mesh.position.y);
...
function updateOctopi(dt, now) {
  ...
  for (let i = octopi.length - 1; i >= 0; i--) {
    ...
    octo.mesh.position.y = clampSpawnY(octo.mesh.position.y);
...
function updateRelics(dt) {
  ...
  for (let i = relics.length - 1; i >= 0; i--) {
    ...
    relic.mesh.position.y = clampSpawnY(relic.mesh.position.y);
    relic.pulse += dt * 2.4;
    if (relic.halo) {
...
function updateJellyfish(dt) {
  for (const jf of jellyfish) {
    ...
    jf.mesh.position.y = clampSpawnY(jf.mesh.position.y);
...
function updateSeahorses(dt) {
  for (const sh of seahorses) {
    ...
    sh.mesh.position.y = clampSpawnY(sh.mesh.position.y);
...
function updateGlowOrbs(dt, now) {
  ...
  for (const orb of glowOrbs) {
    ...
    orb.mesh.position.y = clampSpawnY(orb.mesh.position.y);
...
function updateBubbles(dt) {
  ...
  if (data.options.graphics === 'high' && Math.random() < 0.18) {
    ...
    b.position.y = clampSpawnY(b.position.y);
    scene.add(b);
  ...
  for (let i = bubbles.length - 1; i >= 0; i--) {
    ...
    if (b.mesh.position.y > maxSwimY || b.life <= 0) { scene.remove(b.mesh); bubbles.splice(i, 1); }
  }
}
...
function updateSeabedCreatures(dt, now) {
  ...
  for (const crab of crabs) {
    crab.bob += dt * 1.6;
    crab.mesh.position.y = -81.5 + Math.sin(crab.bob) * 0.04;
